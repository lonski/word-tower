...
class MenuStage extends Stage {
	...
	private static final String START_PREDEFINED = "Start predefined levels";
	private static final String START_GENERATED = "Start autogenerated levels";
	private static final String START_SPECIFIC_PREDEFINED_LEVEL = "Start specific predefined level";
	...
	MenuStage(WordTower game) {
		...
		for (String button : Arrays.asList(
				START_ALL,
				START_PREDEFINED,
				START_GENERATED,
				START_SPECIFIC_PREDEFINED_LEVEL
		)) {
		...
		for (Actor actor : getActors()) {
			...
			if (word.isCompleted()) {
				...
				case START_GENERATED:
					...
					break;
				case START_SPECIFIC_PREDEFINED_LEVEL:
					game.choosePredefinedLevel();
					break;
				}
				break;
			}
